...
import org.camunda.bpm.quarkus.engine.test.cdi.impl.context.beans.LocalVariableBean;
...
public class MultiInstanceTest extends CdiProcessEngineTestCase {
  ...
  static final QuarkusUnitTest unitTest = new QuarkusUnitTest()
      ...
      .setArchiveProducer(() -> ShrinkWrap.create(JavaArchive.class)
          .addClass(LocalVariableBean.class)
          .addAsResource("org/camunda/bpm/quarkus/engine/test/cdi/impl/context/MultiInstanceTest.testParallelMultiInstanceServiceTasks.bpmn20.xml"));

  @Test
  public void testParallelMultiInstanceServiceTasks() {
    repositoryService.createDeployment()
        .addClasspathResource("org/camunda/bpm/quarkus/engine/test/cdi/impl/context/MultiInstanceTest.testParallelMultiInstanceServiceTasks.bpmn20.xml")
        .deploy();
