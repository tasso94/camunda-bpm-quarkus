...
public class ThreadContextAssociationTest extends CdiProcessEngineTestCase {
  ...
  static final QuarkusUnitTest unitTest = new QuarkusUnitTest()
      ...
      .setArchiveProducer(() -> ShrinkWrap.create(JavaArchive.class)
          ...
          .addAsResource("org/camunda/bpm/quarkus/engine/test/cdi/impl/context/ThreadContextAssociationTest.testBusinessProcessScopedWithJobExecutor.bpmn20.xml"));
  
  @Test
  public void testBusinessProcessScopedWithJobExecutor() {
    repositoryService.createDeployment()
        .addClasspathResource("org/camunda/bpm/quarkus/engine/test/cdi/impl/context/ThreadContextAssociationTest.testBusinessProcessScopedWithJobExecutor.bpmn20.xml")
        .deploy();
